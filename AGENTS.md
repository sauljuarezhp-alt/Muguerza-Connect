# Muguerza Connect - Codex Working Rules

This file defines how Codex should work in this repository. Read it before
...
When the user asks to prepare a prompt for Codex/Sonnet, produce a compact
handoff with:
